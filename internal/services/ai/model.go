...
func ExtractPayrollData(text string) (*types.PayrollData, error) {
    ...
    - Los campos numéricos deben ser decimales con un punto (.) como separador y redondear a 2 decimales.
...
` + "\n\n" + text
	...
	var payrollData types.PayrollData
