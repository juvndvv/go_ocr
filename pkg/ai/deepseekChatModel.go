...
// NewDeepseekChatModel crea una nueva instancia del modelo DeepseekChat
func NewDeepseekChatModel(apiKey string) DeepseekChatModel {
...
func (m *DeepseekChatModel) SendPrompt(systemContext string, prompt string) (*string, error) {
